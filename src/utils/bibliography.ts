export function getBibliographyText(bibliography: any): string {
  if (!bibliography) {
    return ''
  }
  return (
    getAuthorAndTitle(bibliography) +
    getTitle(bibliography) +
    getSections(bibliography)
  )
}

export function getAuthorAndTitle(bibliography: any): string {
...
export function getSections(bibliography: any): string {
...
export function getTitle(bibliography: any): string {
...
function formatAuthors(authors: { [key: string]: string }[]): string {
  const names = []
