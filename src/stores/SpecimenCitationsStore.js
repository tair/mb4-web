...
export const useSpecimenCitationsStore = defineStore({
  ...
  actions: {
    async fetchCitations(projectId, specimenId) {
      const response = await apiService.get(`/projects/${projectId}/specimens/${specimenId}/citations`)
    ...
    async create(projectId, specimenId, citationData) {
      try {
        const response = await apiService.post(`/projects/${projectId}/specimens/${specimenId}/citations/create`, { citation: citationData })
        const responseData = await response.json()
    ...
    async edit(projectId, specimenId, citationId, citation) {
      try {
        const response = await apiService.post(`/projects/${projectId}/specimens/${specimenId}/citations/${citationId}/edit`, { citation })
        if (response.ok) {
          const responseData = await response.json()
    ...
    async deleteIds(projectId, specimenId, citationIds) {
      const response = await apiService.post(`/projects/${projectId}/specimens/${specimenId}/citations/delete`, {
